...
// ── AUTO-TAG — faculty-specific grid children without .reveal ─────────────
const autoTargets = [
  { sel: '.prof-card',          stagger: 80  },
  { sel: '.dept-card',          stagger: 70  },
  { sel: '.faculty-list-card',  stagger: 80  },
  { sel: '.fstat-item',         stagger: 90  },
  { sel: '.join-feature',       stagger: 80  },
